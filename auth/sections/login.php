          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <form action="/php/lhizkidoor/auth/controllers/login_controller.php" method="post" class="mx-1 mx-md-4">
                  ...
                  <div class="text-center">
                    <p class="mb-0">¿No tienes cuenta? 
                      <a href="index.php?section=registro" class="text-primary fw-bold">Regístrate</a>
                    </p>
                  </div>
                </form>
              </div>
