      ...
      <div class="left-side">
        ...
        <div class="features-grid">
          <div class="feature-card">
            ...
            <h3>Juegos Semanales</h3>
            <p>Aprende jugando con vocabulario técnico en euskera</p>
          </div>

          <div class="feature-card">
            <i class="bi bi-trophy"></i>
            <h3>Rankings</h3>
            <p>Compite con tus compañeros y alcanza el top</p>
          </div>

          <div class="feature-card">
            <i class="bi bi-journal-text"></i>
            <h3>Glosarios</h3>
            <p>Accede a materiales complementarios</p>
          </div>

         <div class="feature-card">
          <i class="bi bi-calendar2-week"></i>
          <h3>Eventos</h3>
          <p>Consulta tus eventos y su progreso</p>
        </div>
        </div>
      </div>
