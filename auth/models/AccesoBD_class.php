...
class AccesoBD_Auth {
    ...
    public function registrarUsuario(User $user) {
        ...
        $sqlInsert = "INSERT INTO user (rol, nombre, apellido, mail, password, centro, sector, clase, idioma, puntuacionIndividual, token, fechaConfirmacion)
                    VALUES ($rol, '$nombre', '$apellido', '$email', '$password', $centro, $sector, $clase, '$idioma', 0, '$token', NULL)";
