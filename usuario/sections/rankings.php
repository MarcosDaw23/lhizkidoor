...
<body>
    ...
    <div class="ranking-container">
        <div class="ranking-header">
            <h1><i class="bi bi-trophy-fill"></i> <?= t('rankings') ?></h1>
            <p class="subtitle"><?= t('compite_mejores') ?></p>
        ...
        <div class="ranking-card">
            <div id="ranking-table">
                ...
                if (empty($datos)) {
                    ...
                    echo '<h3>' . t('no_datos') . '</h3>';
                    echo '<p>' . t('no_puntuaciones') . '</p>';
                    echo '</div>';
                } else {
                    ...
                    foreach ($datos as $fila) {
                        ...
                        echo '<div class="ranking-subtitle">' . t('familia_formativa') . '</div>';
                        echo '</div>';
                ...
                if (this.status === 200) {
                    ...
                    document.getElementById('ranking-table').innerHTML = `
                        <div class="empty-state">
                            ...
                            <h3><?= t('error_cargar') ?></h3>
                            <p><?= t('intentar_nuevo') ?></p>
                        </div>
                    `;
                }
            };
            xhr.onerror = function() {
                document.getElementById('ranking-table').innerHTML = `
                    <div class="empty-state">
                        ...
                        <h3><?= t('error_conexion') ?></h3>
                        <p><?= t('verifica_conexion') ?></p>
                    </div>
                `;
            };
            xhr.send();
