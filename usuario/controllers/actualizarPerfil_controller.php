...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Validar idioma
    if (!in_array($idioma, ['español', 'euskera'])) {
        $idioma = 'español';
    }
    ...
    // Actualizar perfil
    $resultado = $db->actualizarPerfil($id, $nombre, $apellido, $mail, $centro, $sector, $clase, $idioma, $nueva_password);
